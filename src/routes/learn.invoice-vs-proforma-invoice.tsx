...
import { ARTICLE_CONFIG, ArticleContent } from "@/lib/learn/sprint2/invoice-vs-proforma-invoice";

const meta = learnArticleByPath("/learn/invoice-vs-proforma-invoice")!;
const nav = sprint2NavFor("/learn/invoice-vs-proforma-invoice");

export const Route = createFileRoute("/learn/invoice-vs-proforma-invoice")({
  head: () =>
    createLearnHead({
  ...
  component: InvoiceVsProformaInvoicePage,
});

function InvoiceVsProformaInvoicePage() {
